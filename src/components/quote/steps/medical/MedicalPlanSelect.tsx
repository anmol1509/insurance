      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b" style={{ borderColor: 'var(--border-default)' }}>
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'var(--medical-50)' }}>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr style={{ backgroundColor: 'var(--surface-raised)' }}>
                <th className="text-left px-6 py-4 w-40 border-b" style={{ borderColor: 'var(--border-subtle)' }} />
                {plans.map(plan => (
            ...
            <tbody>
              <tr className="border-b" style={{ borderColor: 'var(--border-subtle)' }}>
                ...
                {plans.map((plan, i) => (
                  <td key={plan.id} className="px-5 py-4 border-l" style={{ borderColor: 'var(--border-subtle)' }}>
                    <p className="font-display font-extrabold text-[22px] leading-none" style={{ color: 'var(--medical-600)' }}>{formatNGN(prices[i])}</p>
              ...
              {([
                ...
                ['Network', 'networkTier'],
              ] as [string, keyof MedicalPlan][]).map(([label, key]) => (
              ...
              <tr>
                <td colSpan={plans.length + 1} className="px-6 py-2.5 font-sans font-bold text-[11px] uppercase tracking-wider" style={{ backgroundColor: 'var(--medical-50)', color: 'var(--medical-700)' }}>
                  Features included
                </td>
              </tr>
