...
const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    summary:
      'AIICO’s docs cover 6 products; only Motor has been shared and integrated so far. Title/gender/body-type/colour/make/model mismatches between AIICO’s controlled vocabulary and this platform’s free-text fields are resolved server-side at submission time.',
    partnerEndpointCount: 15,
    config: [
    ...
    routes: [
      ...
      { method: 'GET', path: '/api/aiico/renewal', partnerEndpoint: 'GetAutoRenewalDetails', purpose: 'Renewal quote for an existing policy' },
      { method: 'POST', path: '/api/aiico/submit/motor-renewal', partnerEndpoint: 'PostMotorRenewalSchedule → FinalizePartnerPayment', purpose: 'Same two-call pattern for renewals' },
    ],
    wiredIn: [
