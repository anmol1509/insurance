...
import { Plus, X, ChevronDown, ChevronUp, Building2, Check } from 'lucide-react'
...
function InsurerRow({ insurer, onAddPlan, onToggleStatus }: { insurer: Insurer; onAddPlan: (ins: Insurer) => void; onToggleStatus: (id: string) => void }) {
  ...
  return (
    <div className="bg-white rounded-2xl border overflow-hidden" style={{ borderColor: 'var(--border-default)' }}>
      ...
      <div className="flex items-center gap-4 px-5 py-4 flex-wrap">
        <div className="w-10 h-10 rounded-2xl flex items-center justify-center font-sans font-bold text-[14px] shrink-0"
