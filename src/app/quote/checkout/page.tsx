  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-[440px] text-center"
      >
        <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-5"
          ...
          >
            <Check className="w-9 h-9" style={{ color: 'var(--green-700)' }} strokeWidth={2.5} />
          </motion.div>
        </div>
        <h2 className="font-display font-extrabold text-[26px] mb-2" style={{ color: 'var(--text-primary)' }}>
          Payment successful!
        </h2>
        <p className="font-sans text-[14px] mb-1" style={{ color: 'var(--text-muted)' }}>
          Your policy certificate is being issued.
        </p>
        <p className="font-sans text-[14px] mb-6" style={{ color: 'var(--text-muted)' }}>
          Check your email and SMS — it'll arrive within <strong>5 minutes</strong>.
        </p>
        <div className="flex flex-col gap-3">
          <Link
            href="/dashboard"
            className="h-12 rounded-2xl font-sans font-semibold text-sm text-white flex items-center justify-center"
          ...
          <Link
            href="/"
            className="h-10 rounded-2xl font-sans font-medium text-sm flex items-center justify-center border"
...
export default function CheckoutPage() {
  ...
  // Mock selected plan (in a real app this'd come from route state / query param)
      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-8 py-6 lg:py-10">
        <div className="grid lg:grid-cols-[1fr_360px] gap-6 lg:gap-8 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* Back link */}
            <Link href="/quote/result"
              className="flex items-center gap-1.5 font-sans text-sm w-fit hover:underline"
            ...
            <div className="bg-white rounded-3xl border p-6 lg:p-8" style={{ borderColor: 'var(--border-default)' }}>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  <label className="font-sans font-medium text-[12px] block mb-1.5" style={{ color: 'var(--text-secondary)' }}>
                    Full name
                  </label>
                  <input
                    type="text"
                    ...
                    style={{
                      borderColor: formErrors.fullName ? 'var(--error)' : 'var(--border-medium)',
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 rounded-xl border-[1.5px] px-3.5 font-sans text-[14px] outline-none transition-colors"
                    style={{
                      borderColor: formErrors.email ? 'var(--error)' : 'var(--border-medium)',
                      color: 'var(--text-primary)',
                    }}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 rounded-xl border-[1.5px] px-3.5 font-sans text-[14px] outline-none transition-colors"
                    style={{
                      borderColor: formErrors.phone ? 'var(--error)' : 'var(--border-medium)',
                      color: 'var(--text-primary)',
                    }}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 rounded-xl border-[1.5px] px-3.5 font-sans text-[14px] outline-none transition-colors"
                    style={{
                      borderColor: formErrors.startDate ? 'var(--error)' : 'var(--border-medium)',
                      color: 'var(--text-primary)',
                    }}
                  />
          ...
          <div className="flex flex-col gap-4 lg:sticky lg:top-[4.5rem]">
            ...
            <div className="bg-white rounded-3xl border p-5" style={{ borderColor: 'var(--border-default)' }}>
              ...
              <div className="flex flex-col gap-2.5">
                {[
                  'Instant digital certificate via email & SMS',
                  'NIID auto-registration (motor)',
                  'Dedicated claims WhatsApp line',
                  '24/7 emergency support',
                  'NAICOM-regulated insurer',
                ].map((item) => (
